<template>
  <div class="wrapper">
    <el-select-v2
      ...
      @change="handleSelect"
    />
    <MemberList :members="members" :options="options" @change="handleMemberChange" :multiple="multiple">
    </MemberList>
  </div>
</template>
...
import { type IMember, type ListItem, type UserRole, roleLabels } from '@/management/utils/types/workSpace'
