        ...
        <div class="template-header">
          ...
          <div class="tooltip-content">
            ...
            <div class="tooltip-text">
              1.调研对象：请提供关于您投放对象的描述，例如年龄、性别、职业等。<br>
              2.调研品牌(选填)：请提供品牌的名称及相关信息。帮助我们更准确地生成问卷内容。<br>
              3.调研目的：请明确您的调查目的，例如：了解产品满意度、客户需求分析、市场竞争格局等。这将引导问卷的整体结构和问题设置。<br>
...
const templateContent = ref(`1.调研对象：请提供关于您投放对象的描述，例如年龄、性别、职业等。
2.调研品牌(选填)：请提供品牌的名称及相关信息。帮助我们更准确地生成问卷内容。
3.调研目的：请明确您的调查目的，例如：了解产品满意度、客户需求分析、市场竞争格局等。这将引导问卷的整体结构和问题设置。
4.题目数量期望(选填)：请提供期望的问卷长度范围，便于AI参考（上限12道题）。`);
